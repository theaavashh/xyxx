...
export const DocumentUploadStepNew = ({ control, errors }: DocumentUploadStepProps) => {
  return (
    <div className="space-y-8">
      <h3 className="text-xl font-semibold text-[#001011] mb-6 absans">८. प्रमाणपत्र संलग्न (Document Upload)</h3>
